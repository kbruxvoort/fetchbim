...
def sync_complete_msg(new_families_count=0, updated_families_count=0, send=True):
    ...
    message.text('Notion Content Calendar has successfully been synced with the admin database')
    message.addLinkButton('Content Calendar', 'https://www.notion.so/fetchbim/f56ac916a3f049dda2df0f864ca63c62')
